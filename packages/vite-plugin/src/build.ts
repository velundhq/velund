...
import { generateLibrary } from './modules/php-gen';
import * as fs from 'fs';
import fg from 'fast-glob';

const buildPlugin = (opts: iTwigPluginConfig): Partial<Plugin> => {
  ...
  return {
    ...
    async writeBundle(options, bundle) {
      ...
      const templates = (globalThis as any).__APP__.templates || [];
      ...
      generateLibrary(templates, path.join(outDir, '/lib'));
    },
  };
};
